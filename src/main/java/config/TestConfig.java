...
public class TestConfig {
    public static String TEMP_MAIL_URL= "https://temp-mail.org/en/";
    public static String YAHOO_ACCOUNT_URL="https://login.yahoo.com/";
    public static String YAHOO_EMAIL_USERNAME="mayankrathore1996@yahoo.com";
    public static String YAHOO_PASSWORD="javaissecure";
